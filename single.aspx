...
<head runat="server">
   <title>Foodiee &mdash; Onepage Website Template by Free-Template.co</title>
    <meta charset="utf-8">
    ...
    <form id="form1" runat="server">
     <header role="banner">
      <nav class="navbar navbar-expand-md navbar-dark bg-dark">
        <div class="container">
          <a class="navbar-brand" href="index.aspx">Foodiee</a>
          ...
          <div class="collapse navbar-collapse" id="navbarsExample05">
            <ul class="navbar-nav ml-auto pl-lg-5 pl-0">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="recipes.aspx">Recipes</a>
              </li>
        ...
        <div class="container">
          <div class="row slider-text align-items-center justify-content-center">
            <div class="col-md-8 text-center col-sm-12 ">
              <h1 data-aos="fade-up">Foodiee Recipes</h1>
      ...
      <div class="container">
        <div class="row mb-5">
          ...
          <div class="col-md-5 mb-5">
            <div class="mb-5">
              <h3>Opening Hours</h3>
              <p><strong class="d-block font-weight-normal text-black">Sunday-Thursday</strong> 12PM - 12AM</p>
            </div>
            <div>
              <h3>Contact Info</h3>
        ...
        <div class="row">
          ...
          <small class="block">&copy; 2019 <strong class="text-black">Foodiee</strong> Free Template. All Rights Reserved. <br> Design by <a href="https://free-template.co/" target="_blank">Free-Template.co</a></small> 
          </p>
          </div>
        </div>
      </div>
